...
//
// Each wrapper (claude, codex, cursor) accepts an Endpoint via a
...
type Endpoint struct {
	...
	// `--config model_providers.<n>.http_headers.*`. claude/cursor
...
// config-load. Operators targeting only claude/cursor still inherit
