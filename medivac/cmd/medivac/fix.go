...
and creates a PR. Supports Claude, Agy, and Codex providers.`,
...
func init() {
	...
	fixCmd.Flags().StringVar(&fixModel, "model", "sonnet", "Model for fix agents (e.g. sonnet, gemini-3.1-pro-high)")
