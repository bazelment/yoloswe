...
var AllModels = []AgentModel{
	...
	{ID: "gpt-6-luna", Provider: ProviderCodex, Label: "gpt-6-luna"},
	{ID: "gpt-6-sol", Provider: ProviderCodex, Label: "gpt-6-sol"},
	{ID: "gpt-6-astra", Provider: ProviderCodex, Label: "gpt-6-astra"},
	{ID: "gpt-5.6-luna", Provider: ProviderCodex, Label: "gpt-5.6-luna"},
	{ID: "gpt-5.6-terra", Provider: ProviderCodex, Label: "gpt-5.6-terra"},
