...
func init() {
	...
	Cmd.Flags().StringVar(&fastModel, "fast-model", "gpt-5.4-mini", "Model for live fast answers")
	Cmd.Flags().StringVar(&researchModel, "research-model", "sonnet", "Model for internal research")
	Cmd.Flags().StringVar(&codeModel, "code-model", "gpt-5.4", "Model for codebase research")
	Cmd.Flags().StringVar(&webModel, "web-model", "gpt-5.4", "Model for public web research")
